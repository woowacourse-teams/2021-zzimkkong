...
public class ValidatorMessage {
    ...
    public static final String NEGATIVE_SETTING_PRIORITY_MESSAGE = "공간 예약 조건 우선순위 값은 음수일 수 없습니다.";
    public static final String DUPLICATE_SETTING_PRIORITY_MESSAGE = "공간 예약 조건 우선순위 값은 서로 중복될 수 없습니다.";
