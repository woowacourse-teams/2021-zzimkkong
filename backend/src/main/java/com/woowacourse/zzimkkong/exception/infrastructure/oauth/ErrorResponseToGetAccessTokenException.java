...
public class ErrorResponseToGetAccessTokenException extends InfrastructureMalfunctionException {
    private static final String MESSAGE = "소셜 로그인에 실패했습니다. 다시 시도해주세요.";

    public ErrorResponseToGetAccessTokenException(String errorMessageFromGithub) {
