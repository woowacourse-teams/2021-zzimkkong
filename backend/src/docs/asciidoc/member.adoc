...
=== 멤버 이메일 중복 확인
==== Request
include::{snippets}/member/getEmail/http-request.adoc[]
==== Response
include::{snippets}/member/getEmail/http-response.adoc[]

=== 멤버 유저 네임 중복 확인
==== Request
include::{snippets}/member/getUserName/http-request.adoc[]
==== Response
include::{snippets}/member/getUserName/http-response.adoc[]
