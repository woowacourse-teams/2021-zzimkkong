...
class SvgConverterTest {
    ...
    void convert() {
        ...
        // when
        this.testFile = svgConverter.convertSvgToPngFile(rawSvgData, "testPngFileName");

        // then
        assertThat(testFile).isEqualTo(new File(SvgConverter.SAVE_DIRECTORY_PATH + "testPngFileName.png"));
    }
