...
class OauthMemberSaveRequestTest extends RequestTest {
    ...
    void blankEmail(String email) {
        OauthMemberSaveRequest oauthMemberSaveRequest = new OauthMemberSaveRequest(email, "sakjung", ProfileEmoji.MAN_DARK_SKIN_TONE_TECHNOLOGIST, "GOOGLE");
    ...
    void blankOauthProvider(String oauthProvider) {
        OauthMemberSaveRequest oauthMemberSaveRequest = new OauthMemberSaveRequest("email@email.com",  "sakjung", ProfileEmoji.MAN_DARK_SKIN_TONE_TECHNOLOGIST, oauthProvider);
